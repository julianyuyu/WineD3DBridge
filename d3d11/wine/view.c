        ...
        D3D10_DEPTH_STENCIL_VIEW_DESC *desc)
{
	...
	LONG off1 = RTL_SIZEOF_THROUGH_FIELD(D3D10_DEPTH_STENCIL_VIEW_DESC, ViewDimension);
	LONG off2 = RTL_SIZEOF_THROUGH_FIELD(D3D11_DEPTH_STENCIL_VIEW_DESC, Flags);
	LONG size = sizeof(D3D10_DEPTH_STENCIL_VIEW_DESC)- off1;
	memcpy((void *)((ULONG_PTR)(&desc) + off1), (void *)((ULONG_PTR)(&d3d11_desc) + off2), size);
}
        ...
        REFIID riid, void **object)
{
    ...
    {
		*object = iface;
        ID3D11UnorderedAccessView_AddRef(iface);
        return S_OK;
    }
